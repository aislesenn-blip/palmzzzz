...
export default async function Dashboard() {
    ...
    return (
        <div className="min-h-screen bg-grey font-sans">
             <nav className="bg-white border-b border-gray-200 sticky top-0 z-30">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-4">
                        {/* Viral Invite Button logic could go here */}
                        <button className="bg-lime text-charcoal px-4 py-2 rounded-full font-bold text-sm flex items-center gap-2 hover:bg-lime/80 transition-colors">
                            <Plus size={16} /> Invite
                        </button>
                        <span className="font-bold text-sm bg-gray-100 px-3 py-1 rounded-full text-charcoal">@{ (session.user as any).handle }</span>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                    ...
                    <div className="bg-electric p-8 rounded-[2rem] shadow-lg flex flex-col justify-center items-center text-center text-white relative overflow-hidden group">
                        <Link href={`/${(session.user as any).handle}`} target="_blank" className="font-bold text-lg hover:underline z-10 flex items-center gap-2">
